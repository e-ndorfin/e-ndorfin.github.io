...
title: 'Flow Matching'
draft: false
description: 'A brief introduction to flow matching.'
pubDate: 'Jan 1 2026'
---
...
(I'd recommend watching 3Blue1Brown's [video](https://www.youtube.com/watch?v=rB83DpBJQsE) on this - his visualizations are extremely helpful)
...
We can see this in example flow matching code ([Lipman et. al., 2024](https://ai.meta.com/research/publications/flow-matching-guide-and-code/)):
```python
import torch 
